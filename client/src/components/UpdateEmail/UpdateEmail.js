...
const UpdateEmail = () => {
    ...
    if (validate) {
      ...
      try {
        ...
        const response = await apiClient
          .patch("users/updateEmail", data)
          .then((response) => {
            //   console.log("response::", response.status);
            if (response) {
              // console.log("yessss", response.data.data);

              const dataEmail = response.data.data;
  ...
  let submitOtp = async (e) => {
    ...
    if (validate) {
      ...
      try {
        ...
        const response = await apiClient
          .patch("users/verfiyOtpProfile", data)
          .then((response) => {
  ...
  let sendOtpAgain = async (e) => {
    ...
    try {
      ...
      const response = await apiClient
        .patch("users/resendOtpCodeProfile", { authValue: resendEmail })
        .then((response) => {
